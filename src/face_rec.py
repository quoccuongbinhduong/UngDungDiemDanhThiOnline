                ...
                if faces_found > 0:
                    ...
                    for i in range(faces_found):
                        ...
                        if best_class_probabilities > 0.6:
                            ...
                            if GDvideo.Video.add_MaMH == "Chọn mã môn học":
                                ...
                                # try:
                                    conn = mysql.connector.connect(host="127.0.0.1", port="3307", username="root",
                                                                   password="root",
                                                                   database="face")
                                    MaMH=GDvideo.Video.add_MaMH()
                                    print(MaMH)
                                    # GDvideo.Video.add_MonHoc
                                    # GDvideo.Video.add_NamHoc
                                    # GDvideo.Video.add_HocKy
                                    my_cursor = conn.cursor()
                                    my_cursor.execute(
                                        "INSERT INTO report (MaMH, MonHoc, NamHoc, HocKy, MaSV, HoTen, Gio, Ngay, ThamGia, TiLe) "
                                    ...
                                    #     messagebox.showerror("Error", f"Vì: {str(es)}")
