...
def record_screen():
    ...
    screen_cap_writer = cv2.VideoWriter('screen_recorded.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 50,
                                        (shape[1], shape[0]))
...
bg_img = PhotoImage(file="D:\\CuongDoAn\\DoAn\\Dataset\\FaceData\\processed\\Nguyen Quoc Cuong\\cuong1.png")
